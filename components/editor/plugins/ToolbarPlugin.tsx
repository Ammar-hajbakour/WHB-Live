...
export default function ToolbarPlugin() {
  ...
  function toggleList(listType: keyof typeof blockTypeToBlockName) {
  ...
  return (
    <div className="toolbar" ref={toolbarRef}>
      ...
      >
        ...
        <ListOrderedIcon className="text-gray-500 " />
      </button>
      <button
      ...
      >
        {/* <i className="format check-list text-white" /> */}
        <ListCheckIcon className="text-gray-500 " />
      </button>
